        ...
        <div className={styles.content}>
          ...
          <div className={styles.iconsArea}>
            ...
            <button
              ...
              className={`${styles.icons} flex flex-col justify-center items-center space-y-1`}
            >
              <div className={`${ props.info.active ? "bg-enabled" : "bg-disabled"  } h-buttonBox w-buttonBox bg-center bg-no-repeat bg-cover bg-white`} />
      ...
      <Transition appear show={isOpen} as={Fragment}>
				<Dialog as="div" className="relative z-10" onClose={closeModal}>
                    ...
                    <div>
                      ...
                      <p>Status: {props.info.active ? "Ativa" : "Inativa"} {console.log(props.info.active)} </p>
                    </div>
