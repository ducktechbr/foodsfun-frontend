  ...
  return (
    <div className="flex px-2 h-14 bg-white" key={props.key}>
      <div className="w-1/8 bg-white">
        <span className="p-2 rounded-2xl bg-white border ">123123</span>
      </div>
      <div className="w-1/8 bg-white">
        <span className="p-2 rounded-2xl bg-white border ">{tableNumber}</span>
      </div>
      <div className="w-1/8 bg-white">
      ...
      <div className="w-4/8 bg-white flex">
        <span className="rounded-2xl bg-white ">{props.current.title}</span>
